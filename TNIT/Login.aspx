<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="TNIT.Login" %>
    ...
    <body oncontextmenu="return false">
        ...
        <div class="page-container">
            ...
            <form action="" runat="server" method="post">
                ...
                <asp:Button ID="submit" class="button" runat="server" Text="登 录" BorderStyle="None" 
                    onclick="submit_Click" />
                <div>
                    <div style="margin-top:25px;margin-bottom:10px;float:left;"><a href="Register.aspx" style="color:#fff;">用户注册</a></div>
