<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HTClass.aspx.cs" Inherits="TNIT.HTClass" %>
...
<body>
    ...
    <ul class="post-ul">
		...
		<div class="post-btn">
            <asp:Button class="post-btn-btn" ID="Button1" runat="server" Text="添加版块" 
